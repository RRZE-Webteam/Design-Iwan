...
function theme_options_init() {
	register_setting('iwan_options', 'iwan_theme_options', 'theme_options_validate');
}
...
function theme_options_do_page($tab = '') {
	...
	<div class="wrap">
		<div class="iwan-optionen">  <!-- begin: .iwan-optionen -->
			...
			if (!isset($setoptions['iwan_theme_options'][$tab])) {
				echo "Invalid Tab-Option or undefined Option-Field $tab";
			}


			echo "<h3 class=\"nav-tab-wrapper\">\n";
			foreach ($setoptions['iwan_theme_options'] as $i => $value) {
								...
								<?php echo $sub ?>
										...
										foreach ($liste as $entry => $listdata) {
											...
											<div style="display: inline-block; width: 90%;" class="<?php echo $name ?>">
												<label for="iwan_theme_options[<?php echo $name ?>][<?php echo $entry ?>][active]" class="<?php echo $entry ?>" style="width: 180px; display: inline-block;">
													<input type="checkbox"
														   id="iwan_theme_options[<?php echo $name ?>][<?php echo $entry ?>][active]"
														   name="iwan_theme_options[<?php echo $name ?>][<?php echo $entry ?>][active]"
														   value="1" <?php echo $checked; ?>>
						<?php echo $liste[$entry]['name'] ?>
												</label>

												<input id="iwan_theme_options[<?php echo $name ?>][<?php echo $entry ?>][content]"
													   type="text" name="iwan_theme_options[<?php echo $name ?>][<?php echo $entry ?>][content]"
										...
										echo "\t\t\t";
										echo "<select name=\"iwan_theme_options[$name]\">\n";
...
function theme_options_validate($input) {
	...
	$saved = (array) get_option('iwan_theme_options');
	//    $options= $saved;
